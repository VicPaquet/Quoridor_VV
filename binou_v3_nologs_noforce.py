...
class MyPlayer(PlayerQuoridor):
   ...
   # Concrètement, retourne une liste des cases qui correspondent au chemin le plus court.
    ...
    def square_grid_4x4(self, current_state: GameStateQuoridor, actions: tuple, player1: PlayerQuoridor, player2: PlayerQuoridor)->tuple:
        """
            Creates a 4x4 grid of possible useful moves
    ...
    def minimax(self, current_state: GameStateQuoridor, depth: int, maximizing_player: bool, alpha: float, beta: float) -> float:
        ...
        if maximizing_player:
            ...
            limited_actions = self.square_grid_4x4(current_state, filtered_ordered_actions, opponent, me)
